...
# 2. Replace the mini cards accurately using regex.
# It starts at `                    {/* Event mini-info cards */}`
...
# 3. Process SectionCards
# We will just replace ALL `<SectionCard>` with `<div className="p-4 sm:p-6">` and `</SectionCard>` with `</div>`
content = content.replace("<SectionCard>", '<div className="p-4 sm:p-6">')
content = content.replace("</SectionCard>", "</div>")

# 4. Group sections into Modals
start_sections = content.find("                {/* ══════════════════════════════════════════════════════════════\n                    SECTION 1: RSVP STATUS")
...
if len(parts) >= 2:
    ...
    # events_code has the closing </div> for the first SectionCard.
