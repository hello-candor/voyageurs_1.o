...
export const DINING_DATA: DiningCategory[] = [
  {
    ...
    restaurants: [
      ...
      },
      {
        ...
        googleQuery: "Napoleon Dynamite ",
        fullDescription: "Located on the most beautiful square in , this is the place to see and be seen while drinking excellent brew.",
    ...
    restaurants: [
      {
        ...
        googleQuery: "Des Rêves et du Pain ",
      ...
      },
      {
        ...
        description: "A  institution since 1962.",
        googleQuery: "Scholler Patisserie ",
  ...
  },
  {
    ...
    restaurants: [
      ...
      },
      {
        ...
        website: "https://www.toast-.fr/",
        openingHours: "Tue-Sun: 10:00 AM – 3:00 PM",
        lat: 43.6078,
        lng: 3.8765
      },
      {
        name: "Les Demoiselles de ",
        ...
        googleQuery: "Les Demoiselles de ",
        ...
        website: "https://lesdemoisellesde.fr/",
  ...
  },
  {
    ...
    restaurants: [
      ...
      },
      {
        ...
        website: "https://www..fr/4166-halles-laissac.htm",
      ...
      },
      {
        ...
        googleQuery: "Burger et Blanquette ",
    ...
    restaurants: [
      {
        ...
        googleQuery: "Gaspard Cocktail Bar ",
      ...
      },
      {
        ...
        website: "https://www.aperture-.com/",
        openingHours: "Tue-Sat: 6:00 PM – 1:00 AM",
        lat: 43.6068,
        lng: 3.8775
      },
  ...
  },
  {
    ...
    restaurants: [
      ...
      },
      {
        ...
        description: "Historic grandeur on the banks of the Lez. A  classic.",
        googleQuery: "La Réserve Rimbaud ",
        fullDescription: "Located in a stunning building by the river, La Réserve Rimbaud is an institution of  gastronomy. Chef Charles Fontès delivers timeless French cuisine with a modern touch.",
      ...
      },
      {
        ...
        website: "https://www.lecenacle.fr/",
        openingHours: "Tue-Sat: 7:30 PM – 9:30 PM",
        lat: 43.6112,
        lng: 3.8760
      },
      {
        ...
        googleQuery: "Restaurant Sensation ",
      ...
      },
      {
        ...
        googleQuery: "L'Artichaut Restaurant ",
      ...
      },
      {
        ...
        googleQuery: "Anga Restaurant ",
        fullDescription: "Anga is the definition of modern  bistronomy. The menu is short, seasonal, and changes constantly. The atmosphere is relaxed but the food is serious.",
        highlights: ["Open Kitchen", "Great Value Lunch", "Natural Wines"],
        signature: "Seasonal Market Menu.",
        website: "https://anga-.fr/",
        openingHours: "Tue-Sat: 12:00 PM – 1:30 PM, 7:30 PM – 9:30 PM",
        lat: 43.6075,
        lng: 3.8788
      },
      {
        ...
        googleQuery: "Restaurant Leclere ",
      ...
      },
      {
        ...
        googleQuery: "L'Arbre Blanc Restaurant ",
      ...
      },
      {
        ...
        website: "https://les-bains-de-.com/",
      ...
      },
      {
        ...
        googleQuery: "Restaurant Ebullition ",
      ...
      },
      {
        ...
        googleQuery: "Maison de la Lozère ",
        fullDescription: "An embassy for the Lozère region right in . Famous for its authentic Aligot (cheesy mashed potatoes) served in a chic, vaulted dining room.",
        highlights: ["Authentic Aligot", "Michelin Recommended", "Regional Wines"],
        signature: "Sausage and Aligot.",
        website: "https://www.lozere-a-.com/",
